...
// Tipos de activos de Tecnología (categoría 2)
const TIPOS_TECNOLOGIA = {
    1: "Computadora",
    2: "Laptop",
    3: "Impresora",
    4: "Monitor",
...
export default function Tecnologia() {
    ...
    const cargarActivos = async () => {
        try {
            ...
            const filtrados = respuesta.data.filter((a) =>
                Object.keys(TIPOS_TECNOLOGIA).includes(String(a.idTipo))
            );
            setActivos(filtrados);
        } catch (error) {
            console.error(error);
            mostrarMensaje("No se pudieron cargar los activos", "error");
        }
    };
    ...
    const registrarActivo = async (e) => {
        ...
        try {
            ...
            console.error(error);
            mostrarMensaje(
                error.response?.data?.mensaje || "No se pudo guardar el activo",
                "error"
            );
        }
    };
    ...
    const borrarActivo = async (id) => {
        ...
        try {
            ...
            mostrarMensaje("Activo eliminado correctamente", "exito");
            cargarActivos();

        } catch (error) {
            console.error(error);
            mostrarMensaje(
                error.response?.data?.mensaje || "No se pudo eliminar el activo",
                "error"
            );
        }
    };
    ...
    const calcular = async () => {
        if (!activoSeleccionado) {
            return mostrarMensaje("Seleccione un activo", "error");
        }
        if (!fechaCalculo) {
    ...
    // ============ UTILS ============
    const nombreTipo = (idTipo) => TIPOS_TECNOLOGIA[idTipo] || "Desconocido";
    ...
    return (
        <Layout>
            <div className="page-header">
                <div>
                    ...
                    <p className="subtitle">
                        Registra, edita y calcula la depreciación de equipos tecnológicos
                    </p>
                </div>
            ...
            <div className="form-grid-dos">
                <div className="card">
                    <h2 className="card-title">
                        {editando ? "Editar activo" : "Registrar activo"}
                    </h2>
                    <p className="card-subtitle">
                        {editando ? "Modifica los datos del activo" : "Ingresa los datos del activo"}
                    </p>
                    ...
                    <form onSubmit={registrarActivo}>
                        ...
                        <div className="form-field">
                            ...
                            >
                                ...
                                {Object.entries(TIPOS_TECNOLOGIA).map(([id, nombre]) => (
                        ...
                        <div style={{ display: "flex", gap: 10, marginTop: 8 }}>
                            <button className="btn btn-primary" type="submit">
                                <IconCheck />
                                {editando ? "Actualizar activo" : "Registrar activo"}
                            </button>
                ...
                <div className="card">
                    ...
                    <p className="card-subtitle">
                        Se calcula automáticamente con los datos del activo
                    </p>
            ...
            <div className="card">
                ...
                <p className="card-subtitle">Lista de equipos tecnológicos en el sistema</p>
            ...
            {activoSeleccionado && (
                <div className="card">
                    <h2 className="card-title">Depreciación del activo</h2>
                    <p className="card-subtitle">
                        Historial anual y consulta por fecha
                    </p>

                    <div className="form-grid" style={{ marginBottom: 20 }}>
                        <InfoItem label="Activo" value={activoSeleccionado.descripcion} />
